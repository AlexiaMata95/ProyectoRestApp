...
import llamar from './images/llamar.png'
...
const home = () => {
  ...
  <section className='informacion'>
    ...
    <dl>
      ...
      <dd>Puedes hacerlo vía telefónica, Whatsapp o en este <a href='#'>enlace</a></dd>
      <dt>Cotiza tu evento</dt>
      <dd>Deleita a tus invitados con nuestro sabor</dd>
    </dl>
    <ul>
      <li><a href= 'https://wa.me/'><img src={whatsapp}></img>(+052) - 777 123 4567</a></li>
      <li><a href='tel:+527771234567'><img src={llamar}></img>(+052) - 777 123 4567</a></li>
      <li><a href='mailto:driedyeca@email.com.mx'><img src={email}></img> driedyeca@email.com.mx</a></li>
    </ul>
    </div>
